// @flow
// flow-typed signature: 7e631c70878bf860deba17fa57759e24
// flow-typed version: <<STUB>>/eslint_v7.30.0/flow_v0.154.0
...
declare module 'eslint' {
  ...
  declare type DeprecatedRule = {
    ruleId: string,
    replacedBy: string[],
  };

  declare export type EditInfo = {
    range: [number, number],
    text: string,
  };
  ...
  declare export type LintMessage = {
    ruleId: ?string,
    severity: 1 | 2,
    message: string,
    line: number,
  ...
  declare export type LintResult = {
    filePath: string,
